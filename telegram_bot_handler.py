...
HELP_TEXT = (
    "🤖 <b>Trading Bot 명령어 목록</b>\n"
    "━━━━━━━━━━━━━━\n"
    "▶️ <b>봇 제어</b>\n"
    "<code>/start_bot</code> — 봇 시작\n"
    "<code>/stop_bot</code> — 봇 정지\n\n"
    "⚙️ <b>설정 변경</b>\n"
    "<code>/mode testnet</code> — 테스트넷 전환\n"
    "<code>/mode mainnet</code> — 상용 전환\n"
    "<code>/strategy ema</code> — EMA 전략\n"
    "<code>/strategy macd</code> — MACD 전략\n"
    "<code>/strategy rsi</code> — RSI 전략\n"
    "<code>/strategy ss</code> — StructureShock 전략\n"
    "<code>/coin eth</code> — 이더리움으로 변경\n"
    "<code>/coin btc</code> — 비트코인으로 변경\n\n"
    "📊 <b>조회</b>\n"
    "<code>/status</code> — 봇 현재 상태\n"
    "<code>/balance</code> — 잔고 조회\n"
    "<code>/position</code> — 포지션 조회\n"
    "<code>/market</code> — 시장 현황\n"
    "<code>/sentiment</code> — 시장 심리 지표\n"
